    ...
    <div className="bg-slate-50 min-h-screen">
      ...
      <div className="max-w-4xl mx-auto px-6 py-12 md:py-20">
        <div className="prose prose-slate max-w-none">
          ...
          <section className="mb-12 md:mb-16 p-8 md:p-14 bg-gradient-to-br from-blue-50 via-white to-blue-50/50 rounded-3xl md:rounded-[3rem] border border-blue-100 shadow-sm relative overflow-hidden group">
            {/* Background design elements */}
            <div className="absolute top-0 right-0 w-64 h-64 bg-blue-100/50 rounded-full blur-3xl -mr-32 -mt-32 transition-transform duration-1000 group-hover:scale-110 pointer-events-none"></div>
            
            <div className="relative z-10 w-full">
              <div className="flex items-center gap-4 mb-8 md:mb-12">
                <div className="h-px bg-blue-900/10 flex-1"></div>
                <h2 className="text-2xl md:text-3xl font-playfair font-black text-blue-900 tracking-tight">How NETI Can Help</h2>
                <div className="h-px bg-blue-900/10 flex-1"></div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
                {[
                  ...
                  <div key={service.title} className="bg-white/80 backdrop-blur-sm p-6 md:p-8 rounded-2xl border border-blue-50 hover:border-blue-200 hover:shadow-lg hover:shadow-blue-900/5 transition-all duration-300 group/card relative overflow-hidden">
                    <div className="absolute top-0 right-0 p-4 opacity-5 group-hover/card:opacity-10 transition-opacity transform group-hover/card:scale-110 duration-500 pointer-events-none text-blue-900">
                      {service.icon}
                    </div>
                    <div className="w-12 h-12 bg-blue-50 text-blue-600 rounded-xl flex items-center justify-center mb-5 box-border border border-blue-100 group-hover/card:bg-blue-600 group-hover/card:text-white transition-colors duration-300 shadow-sm relative z-10">
                      {service.icon}
                    </div>
              ...
              <div className="mt-10 md:mt-14 p-4 md:p-5 bg-blue-900/5 rounded-xl border border-blue-900/10 flex gap-3 md:gap-4 items-start md:items-center">
                <div className="w-8 h-8 rounded-full bg-blue-100 flex items-center justify-center flex-shrink-0 mt-1 md:mt-0 text-blue-600">
                ...
                <p className="text-xs md:text-sm text-slate-700 italic font-medium leading-relaxed pr-2">
                  <span className="font-bold border-b border-blue-900/30 pb-0.5 text-blue-900">Note:</span> We are not a placement firm. We simply sit with you, understand where you are, and help you think clearly.
                </p>
              </div>
            </div>
          </section>
